...
```{r data_info, echo=FALSE, warning=FALSE, message=FALSE, results="asis", fig.width=10, dpi=300}
cat("\n\n")
...
```{r sel_1, echo=FALSE, warning=FALSE, message=FALSE, results="asis", fig.width=10, dpi=300}
...
```{r sel_2, echo=FALSE, warning=FALSE, message=FALSE, results="asis", fig.width=10, dpi=300}
# plot barplot for each sample in separate tabs
for (i in c(1:length(rdata_list))){
    cat("### ", names(rdata_list)[i], " {.tabset} \n \n")
...
```{r sel_3, echo=FALSE, warning=FALSE, message=FALSE, results="asis", fig.width=10, dpi=300}
# plot barplot for each sample in separate tabs
for (i in c(1:length(rdata_list))){
    cat("### ", names(rdata_list)[i], " {.tabset} \n \n")
...
```{r sel_4, echo=FALSE, warning=FALSE, message=FALSE, results="asis", fig.height=8,fig.width=10, dpi=300}
# plot barplot for each sample in separate tabs
for (i in c(1:length(rdata_list))){
    cat("### ", names(rdata_list)[i], " {.tabset} \n \n")
...
```{r norf_1, echo=FALSE, warning=FALSE, message=FALSE, results="asis", fig.width=10, dpi=300}
...
```{r norf_2, echo=FALSE, warning=FALSE, message=FALSE, results="asis", fig.width=10, dpi=300}
# plot distribution for each sample in separate tabs
for (i in c(1:length(rdata_list))){
    cat("### ", names(rdata_list)[i], " {.tabset} \n \n")
...
```{r norf_3, echo=FALSE, warning=FALSE, message=FALSE, results="asis", fig.width=10, dpi=300}
# plot distribution for each sample in separate tabs
for (i in c(1:length(rdata_list))){
    cat("### ", names(rdata_list)[i], " {.tabset} \n \n")
...
## 2.4 ORFs Per Million (ORFs_pM) {.tabset}

```{r norf_4, echo=FALSE, warning=FALSE, message=FALSE, results="asis", fig.width=10, dpi=300}
# plot distribution for each sample in separate tabs
for (i in c(1:length(rdata_list))){
    cat("### ", names(rdata_list)[i], " {.tabset} \n \n")
...
```{r orfg_1, echo=FALSE, warning=FALSE, message=FALSE, results="asis", fig.width=10, dpi=300}
# plot distribution for each sample in separate tabs
for (i in c(1:length(rdata_list))){
    cat("### ", names(rdata_list)[i], " {.tabset} \n \n")
...
```{r orfg_2, echo=FALSE, warning=FALSE, message=FALSE, results="asis", fig.width=10, dpi=300}
# plot distribution for each sample in separate tabs
for (i in c(1:length(rdata_list))){
    cat("### ", names(rdata_list)[i], " {.tabset} \n \n")
...
```{r orfg_3, echo=FALSE, warning=FALSE, message=FALSE, results="asis", fig.width=10, dpi=300}
# plot distribution for each sample in separate tabs
for (i in c(1:length(rdata_list))){
    cat("### ", names(rdata_list)[i], " {.tabset} \n \n")
...
```{r orfg_4, echo=FALSE, warning=FALSE, message=FALSE, results="asis", fig.width=10, dpi=300}
# plot distribution for each sample in separate tabs
for (i in c(1:length(rdata_list))){
    cat("### ", names(rdata_list)[i], " {.tabset} \n \n")
